...
p;8;CPMenu.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPString.ji;15;CPApplication.ji;12;CPClipView.ji;12;CPMenuItem.ji;9;CPPanel.jc;49722;
...
}),new objj_method(sel_getUid("setIconImage:"),function(self,_cmd,_179){
with(self){
objj_msgSend(_iconImageView,"setImage:",_179);
objj_msgSend(_iconImageView,"setHidden:",_179==nil);
objj_msgSend(self,"tile");
}
}),new objj_method(sel_getUid("setIconImageAlphaValue:"),function(self,_cmd,_17c){
with(self){
objj_msgSend(_iconImageView,"setAlphaValue:",_17c);
}
}),new objj_method(sel_getUid("setColor:"),function(self,_cmd,_17f){
with(self){
if(!_17f){
if(!_16e){
...
objj_msgSend(objj_msgSend(self,"contentView"),"setBackgroundColor:",_17f);
}
}
}),new objj_method(sel_getUid("setTextColor:"),function(self,_cmd,_182){
with(self){
if(_textColor==_182){
return;
}
...
}),new objj_method(sel_getUid("setTitleColor:"),function(self,_cmd,_185){
with(self){
if(_titleColor==_185){
return;
}
_titleColor=_185;
objj_msgSend(_titleField,"setTextColor:",_185?_185:objj_msgSend(CPColor,"blackColor"));
}
}),new objj_method(sel_getUid("setTextShadowColor:"),function(self,_cmd,_188){
with(self){
if(_textShadowColor==_188){
return;
}
_textShadowColor=_188;
objj_msgSend(_menuItemViews,"makeObjectsPerformSelector:withObject:",sel_getUid("setTextShadowColor:"),_textShadowColor);
}
}),new objj_method(sel_getUid("setTitleShadowColor:"),function(self,_cmd,_18b){
with(self){
if(_titleShadowColor==_18b){
return;
}
_titleShadowColor=_18b;
objj_msgSend(_titleField,"setTextShadowColor:",_18b?_18b:objj_msgSend(CPColor,"whiteColor"));
}
}),new objj_method(sel_getUid("setHighlightColor:"),function(self,_cmd,_18e){
with(self){
if(_highlightColor==_18e){
return;
}
_highlightColor=_18e;
}
}),new objj_method(sel_getUid("setHighlightTextColor:"),function(self,_cmd,_191){
with(self){
if(_highlightTextColor==_191){
return;
}
_highlightTextColor=_191;
objj_msgSend(_menuItemViews,"makeObjectsPerformSelector:withObject:",sel_getUid("setActivateColor:"),_highlightTextColor);
}
}),new objj_method(sel_getUid("setHighlightTextShadowColor:"),function(self,_cmd,_194){
with(self){
if(_highlightTextShadowColor==_194){
return;
}
_highlightTextShadowColor=_194;
...
}),new objj_method(sel_getUid("setMenu:"),function(self,_cmd,_197){
with(self){
if(_menu==_197){
return;
}
var _198=objj_msgSend(CPNotificationCenter,"defaultCenter");
if(_menu){
objj_msgSend(_198,"removeObserver:name:object:",self,CPMenuDidAddItemNotification,_menu);
objj_msgSend(_198,"removeObserver:name:object:",self,CPMenuDidChangeItemNotification,_menu);
objj_msgSend(_198,"removeObserver:name:object:",self,CPMenuDidRemoveItemNotification,_menu);
var _199=objj_msgSend(_menu,"itemArray"),_19a=_199.length;
while(_19a--){
objj_msgSend(objj_msgSend(_199[_19a],"_menuItemView"),"removeFromSuperview");
}
}
_menu=_197;
if(_menu){
objj_msgSend(_198,"addObserver:selector:name:object:",self,sel_getUid("menuDidAddItem:"),CPMenuDidAddItemNotification,_menu);
objj_msgSend(_198,"addObserver:selector:name:object:",self,sel_getUid("menuDidChangeItem:"),CPMenuDidChangeItemNotification,_menu);
objj_msgSend(_198,"addObserver:selector:name:object:",self,sel_getUid("menuDidRemoveItem:"),CPMenuDidRemoveItemNotification,_menu);
}
_menuItemViews=[];
var _19b=objj_msgSend(self,"contentView"),_199=objj_msgSend(_menu,"itemArray"),_19a=_199.length;
for(index=0;index<_19a;++index){
var item=_199[index],_19d=objj_msgSend(item,"_menuItemView");
_menuItemViews.push(_19d);
objj_msgSend(_19d,"setShowsStateColumn:",NO);
objj_msgSend(_19d,"setBelongsToMenuBar:",YES);
objj_msgSend(_19d,"setFont:",_16f);
objj_msgSend(_19d,"setTextColor:",_textColor);
objj_msgSend(_19d,"setHidden:",objj_msgSend(item,"isHidden"));
objj_msgSend(_19d,"synchronizeWithMenuItem");
objj_msgSend(_19b,"addSubview:",_19d);
}
objj_msgSend(self,"tile");
}
}),new objj_method(sel_getUid("menuDidChangeItem:"),function(self,_cmd,_1a0){
with(self){
var _1a1=objj_msgSend(_menu,"itemAtIndex:",objj_msgSend(objj_msgSend(_1a0,"userInfo"),"objectForKey:","CPMenuItemIndex")),_1a2=objj_msgSend(_1a1,"_menuItemView");
objj_msgSend(_1a2,"setHidden:",objj_msgSend(_1a1,"isHidden"));
objj_msgSend(_1a2,"synchronizeWithMenuItem");
objj_msgSend(self,"tile");
}
}),new objj_method(sel_getUid("menuDidAddItem:"),function(self,_cmd,_1a5){
with(self){
var _1a6=objj_msgSend(objj_msgSend(_1a5,"userInfo"),"objectForKey:","CPMenuItemIndex"),_1a7=objj_msgSend(_menu,"itemAtIndex:",_1a6),_1a8=objj_msgSend(_1a7,"_menuItemView");
objj_msgSend(_menuItemViews,"insertObject:atIndex:",_1a8,_1a6);
objj_msgSend(_1a8,"setShowsStateColumn:",NO);
objj_msgSend(_1a8,"setBelongsToMenuBar:",YES);
objj_msgSend(_1a8,"setFont:",_16f);
objj_msgSend(_1a8,"setTextColor:",_textColor);
objj_msgSend(_1a8,"setHidden:",objj_msgSend(_1a7,"isHidden"));
objj_msgSend(_1a8,"synchronizeWithMenuItem");
objj_msgSend(objj_msgSend(self,"contentView"),"addSubview:",_1a8);
objj_msgSend(self,"tile");
}
}),new objj_method(sel_getUid("menuDidRemoveItem:"),function(self,_cmd,_1ab){
with(self){
var _1ac=objj_msgSend(objj_msgSend(_1ab,"userInfo"),"objectForKey:","CPMenuItemIndex"),_1ad=objj_msgSend(_menuItemViews,"objectAtIndex:",_1ac);
objj_msgSend(_menuItemViews,"removeObjectAtIndex:",_1ac);
objj_msgSend(_1ad,"removeFromSuperview");
objj_msgSend(self,"tile");
}
}),new objj_method(sel_getUid("frameForMenuItem:"),function(self,_cmd,_1b0){
with(self){
var _1b1=objj_msgSend(objj_msgSend(_1b0,"_menuItemView"),"frame");
_1b1.origin.x-=5;
_1b1.origin.y=0;
_1b1.size.width+=10;
_1b1.size.height=_1;
...
}),new objj_method(sel_getUid("menuItemAtPoint:"),function(self,_cmd,_1b4){
with(self){
var _1b5=objj_msgSend(_menu,"itemArray"),_1b6=_1b5.length;
while(_1b6--){
var item=_1b5[_1b6];
if(objj_msgSend(item,"isHidden")||objj_msgSend(item,"isSeparatorItem")){
continue;
}
if(CGRectContainsPoint(objj_msgSend(self,"frameForMenuItem:",item),_1b4)){
return item;
}
}
return nil;
}
}),new objj_method(sel_getUid("mouseDown:"),function(self,_cmd,_1ba){
with(self){
_trackingMenuItem=objj_msgSend(self,"menuItemAtPoint:",objj_msgSend(_1ba,"locationInWindow"));
if(!objj_msgSend(_trackingMenuItem,"isEnabled")){
return;
}
if(objj_msgSend(objj_msgSend(_trackingMenuItem,"_menuItemView"),"eventOnSubmenu:",_1ba)){
return objj_msgSend(self,"showMenu:",_1ba);
}
if(objj_msgSend(_trackingMenuItem,"isEnabled")){
objj_msgSend(self,"trackEvent:",_1ba);
}
}
}),new objj_method(sel_getUid("trackEvent:"),function(self,_cmd,_1bd){
with(self){
var type=objj_msgSend(_1bd,"type");
if(type===CPPeriodic){
return objj_msgSend(self,"showMenu:",_1bd);
}
var _1bf=objj_msgSend(self,"frameForMenuItem:",_trackingMenuItem),_1c0=objj_msgSend(_trackingMenuItem,"_menuItemView"),_1c1=CGRectContainsPoint(_1bf,objj_msgSend(_1bd,"locationInWindow"));
if(type==CPLeftMouseDown){
if(objj_msgSend(_trackingMenuItem,"submenu")!=nil){
var _1c2=objj_msgSend(_trackingMenuItem,"action");
if(!_1c2||_1c2===sel_getUid("submenuAction:")){
return objj_msgSend(self,"showMenu:",_1bd);
}
objj_msgSend(CPEvent,"startPeriodicEventsAfterDelay:withPeriod:",0,0.5);
}
objj_msgSend(_1c0,"highlight:",_1c1);
}else{
if(type==CPLeftMouseDragged){
if(!_1c1&&objj_msgSend(_trackingMenuItem,"submenu")){
return objj_msgSend(self,"showMenu:",_1bd);
}
objj_msgSend(_1c0,"highlight:",_1c1);
}else{
objj_msgSend(CPEvent,"stopPeriodicEvents");
objj_msgSend(_1c0,"highlight:",NO);
if(_1c1){
...
}),new objj_method(sel_getUid("showMenu:"),function(self,_cmd,_1c5){
with(self){
objj_msgSend(CPEvent,"stopPeriodicEvents");
var _1c6=objj_msgSend(self,"frameForMenuItem:",_trackingMenuItem),_1c7=objj_msgSend(_trackingMenuItem,"_menuItemView");
if(!_highlightView){
_highlightView=objj_msgSend(objj_msgSend(CPView,"alloc"),"initWithFrame:",_1c6);
...
objj_msgSend(_highlightView,"setFrame:",_1c6);
}
objj_msgSend(objj_msgSend(self,"contentView"),"addSubview:positioned:relativeTo:",_highlightView,CPWindowBelow,_1c7);
objj_msgSend(_1c7,"activate:",YES);
var _1c8=objj_msgSend(_trackingMenuItem,"submenu");
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"addObserver:selector:name:object:",self,sel_getUid("menuDidEndTracking:"),CPMenuDidEndTrackingNotification,_1c8);
objj_msgSend(CPMenu,"_popUpContextMenu:withEvent:forView:withFont:forMenuBar:",_1c8,objj_msgSend(CPEvent,"mouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:",CPLeftMouseDown,CGPointMake(CGRectGetMinX(_1c6),CGRectGetMaxY(_1c6)),objj_msgSend(_1c5,"modifierFlags"),objj_msgSend(_1c5,"timestamp"),objj_msgSend(self,"windowNumber"),nil,0,objj_msgSend(_1c5,"clickCount"),objj_msgSend(_1c5,"pressure")),objj_msgSend(self,"contentView"),nil,YES);
}
}),new objj_method(sel_getUid("menuDidEndTracking:"),function(self,_cmd,_1cb){
with(self){
objj_msgSend(_highlightView,"removeFromSuperview");
objj_msgSend(objj_msgSend(_trackingMenuItem,"_menuItemView"),"activate:",NO);
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"removeObserver:name:object:",self,CPMenuDidEndTrackingNotification,objj_msgSend(_1cb,"object"));
}
}),new objj_method(sel_getUid("tile"),function(self,_cmd){
with(self){
var _1ce=objj_msgSend(_menu,"itemArray"),_1cf=0,_1d0=_1ce.length,x=_16c,y=0,_1d3=YES;
for(;_1cf<_1d0;++_1cf){
var item=_1ce[_1cf];
...
var _1d5=objj_msgSend(item,"_menuItemView"),_1d6=objj_msgSend(_1d5,"frame");
if(_1d3){
objj_msgSend(_1d5,"setFrameOrigin:",CGPointMake(x,(_1-1-CGRectGetHeight(_1d6))/2));
x+=CGRectGetWidth(objj_msgSend(_1d5,"frame"))+_16b;
}else{
objj_msgSend(_1d5,"setFrameOrigin:",CGPointMake(x-CGRectGetWidth(_1d6),(_1-1-CGRectGetHeight(_1d6))/2));
x=CGRectGetMinX(objj_msgSend(_1d5,"frame"))-_16b;
}
}
var _1d7=objj_msgSend(objj_msgSend(self,"contentView"),"bounds"),_1d8=objj_msgSend(_titleField,"frame");
if(objj_msgSend(_iconImageView,"isHidden")){
objj_msgSend(_titleField,"setFrameOrigin:",CGPointMake((CGRectGetWidth(_1d7)-CGRectGetWidth(_1d8))/2,(CGRectGetHeight(_1d7)-CGRectGetHeight(_1d8))/2));
}else{
var _1d9=objj_msgSend(_iconImageView,"frame"),_1da=CGRectGetWidth(_1d9),_1db=_1da+CGRectGetWidth(_1d8);
objj_msgSend(_iconImageView,"setFrameOrigin:",CGPointMake((CGRectGetWidth(_1d7)-_1db)/2,(CGRectGetHeight(_1d7)-CGRectGetHeight(_1d9))/2));
objj_msgSend(_titleField,"setFrameOrigin:",CGPointMake((CGRectGetWidth(_1d7)-_1db)/2+_1da,(CGRectGetHeight(_1d7)-CGRectGetHeight(_1d8))/2));
}
}
}),new objj_method(sel_getUid("setFrame:display:animate:"),function(self,_cmd,_1de,_1df,_1e0){
with(self){
var size=objj_msgSend(self,"frame").size;
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPPanel")},"setFrame:display:animate:",_1de,_1df,_1e0);
if(!(size.width==_1de.size.width&&size.height==_1de.size.height)){
objj_msgSend(self,"tile");
}
}
})]);
...
var _1e4=objj_msgSend(CPBundle,"bundleForClass:",self);
...
p;8;CPView.jI;20;Foundation/CPArray.jI;26;Foundation/CPObjJRuntime.ji;19;CGAffineTransform.ji;12;CGGeometry.ji;9;CPColor.ji;12;CPGeometry.ji;19;CPGraphicsContext.ji;13;CPResponder.ji;9;CPTheme.ji;18;_CPDisplayServer.jc;43719;
CPViewNotSizable=0;
CPViewMinXMargin=1;
...
var _2c="CPViewControllerViewKey",_2d="CPViewControllerTitleKey",_2e="CPViewControllerCibNameKey",_2f="CPViewControllerBundleKey";
...
with(_30){
_30=objj_msgSendSuper({receiver:_30,super_class:objj_getClass("CPResponder")},"initWithCoder:",_32);
if(_30){
_view=objj_msgSend(_32,"decodeObjectForKey:",_2c);
_title=objj_msgSend(_32,"decodeObjectForKey:",_2d);
_cibName=objj_msgSend(_32,"decodeObjectForKey:",_2e);
var _33=objj_msgSend(_32,"decodeObjectForKey:",_2f);
_cibBundle=_33?objj_msgSend(CPBundle,"bundleWithPath:",_33):objj_msgSend(CPBundle,"mainBundle");
_cibExternalNameTable=objj_msgSend(CPDictionary,"dictionaryWithObject:forKey:",_30,CPCibOwner);
}
return _30;
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_34,_35,_36){
with(_34){
objj_msgSendSuper({receiver:_34,super_class:objj_getClass("CPResponder")},"encodeWithCoder:",_36);
objj_msgSend(_36,"encodeObject:forKey:",_view,_2c);
objj_msgSend(_36,"encodeObject:forKey:",_title,_2d);
objj_msgSend(_36,"encodeObject:forKey:",_cibName,_2e);
objj_msgSend(_36,"encodeObject:forKey:",objj_msgSend(_cibBundle,"bundlePath"),_2f);
}
})]);
